  ...
  const plans = [
    {
      ...
      features: [
        ...
        { text: 'Uptime badges (24h, 7d)', included: true },
        { text: 'Community support', included: true },
        { text: 'Discord alerts', included: false },
        { text: 'SSL certificate monitoring', included: false },
      ],
    ...
    },
    {
      ...
      features: [
        ...
        { text: 'Custom branding (logo)', included: true },
                { text: 'Uptime badges (24h, 7d, 30d)', included: true },
        { text: 'Priority support', included: true },
        { text: 'Discord alerts', included: true },
        { text: 'SSL certificate monitoring', included: true },
      ],
      cta: 'Start Pro',
      highlight: true,
      popular: true,
    ...
    },
    {
      ...
      features: [
        ...
        { text: 'Public status pages', included: true },
        { text: 'Custom branding (logo)', included: true },
                { text: 'Uptime badges (24h, 7d, 30d, 90d)', included: true },
